...
class editBillingForm extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            nameProduct:'',
        ...
        this.handleSubmitEditBilling = this.handleSubmitEdditBilling.bind(this);
        ...
        return (
            <div>
                <div className="addBillingForm"><h1>NEW BILLING</h1>
                    ...
                    <div>
                        <button className="btn btn-primary" type="submit" onClick={this.handleSubmitEditBilling}>Submit</button>
                    </div>
                </div>
            </div>
        )
